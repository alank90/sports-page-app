                            ...
                            <div class="col-xs-12 col-sm-4 col-lg-3" v-for="arrayItem in dayDataArray"> 
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="team-logo"> 
                                            <img v-if="arrayItem.game.awayTeam.Abbreviation === 'NYJ'" class="team-logo" scope="row" src="./src/img/nyj.png">
                                            <img v-if="arrayItem.game.awayTeam.Abbreviation === 'NYG'" class="team-logo" scope="row" src="./src/img/nyg.png">
                                        </tr>
                                        ...
                                        <tr class="team-logo"> 
                                            <img v-if="arrayItem.game.homeTeam.Abbreviation === 'NYJ'" class="team-logo" scope="row" src="./src/img/nyj.png">
                                            <img v-if="arrayItem.game.homeTeam.Abbreviation === 'NYG'" class="team-logo" scope="row" src="./src/img/nyg.png">
                                        </tr>
