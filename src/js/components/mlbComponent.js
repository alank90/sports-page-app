                  ...
                  <table class="table table-striped table-sm">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><img scope="row" v-if="value.game.awayTeam.Abbreviation === 'NYY'" src="./src/img/nym.png"></td>
                            </tr>
                            <tr>
                                ...
                                <td><img scope="row" v-if="value.game.homeTeam.Abbreviation === 'NYY'" src="./src/img/nym.png"></td>
                            </tr>
                        </tbody>
                    </table>
              </div> <!-- End v-for -->
